...
class MbedTLSConan(ConanFile):
    ...
    def source(self):
        ...
        x509_crt_h = os.path.join(self._source_subfolder, 'include', 'mbedtls', 'x509_crt.h')
        ...
        tools.replace_in_file(os.path.join(self._source_subfolder, 'include', 'mbedtls', 'bn_mul.h'),
                              '#if defined(__i386__) && defined(__OPTIMIZE__)',
                              '#if defined(__i386__) && defined(__OPTIMIZE__) && !defined(__PIC__)')
        tools.replace_in_file(os.path.join(self._source_subfolder, 'library', 'CMakeLists.txt'),
    ...
    def package(self):
        ...
        self.copy(pattern="apache-2.0.txt", dst="licenses", src=self._source_subfolder)
        cmake = self._configure_cmake()
        cmake.install()
